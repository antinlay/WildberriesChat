...
extension Contact {
    static var contacts: [Contact] = [
        ...
        .init(firstName: "Иван Иванов", onlineStatus: "Online", activeStories: false, phoneNumber: "+79999999995"),
        .init(firstName: "Лиса Алиса", onlineStatus: "Last seen 30 minutes ago", activeStories: true, phoneNumber: "+79999999994")
    ]
}
